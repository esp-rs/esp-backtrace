fn main() {
    ...
    // enabled, either the `esp32c2`, `esp32c3`, `esp32c6`, `esp32h2`, or `esp32s3`
    // chip feature is enabled.
    ...
    {
        panic!(
            "The `print-jtag-serial` feature is only supported by the ESP32-C2, ESP32-C3, ESP32-C6, ESP32-H2, and ESP32-S3"
        );
    }
}
